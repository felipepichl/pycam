...
const DEFAULT_SERVER_URL = 'http://192.168.1.205:3000';
...
export function useStreaming() {
  ...
  const sendFrame = useCallback(
    async (frame: Uint8Array) => {
      console.log('🔵 sendFrame called - isStreaming:', isStreaming, 'isSending:', isSendingRef.current, 'frameSize:', frame.length);
